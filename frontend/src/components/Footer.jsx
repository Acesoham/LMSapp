      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-14">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="col-span-2 lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-gray-900 tracking-tight">EduFlow</span>
            </Link>
            <p className="text-sm text-gray-500 leading-relaxed max-w-xs mb-5">
              A premier digital campus dedicated to curating the most transformative education experience for ambitious professionals.
            </p>
            {/* Social icons */}
            <div className="flex gap-3">
              {[
                ...
                <a key={s.label} href="#" aria-label={s.label}
                  ...
                  style={{ color: '#9ca3af' }}>
                  <svg className="w-4 h-4" viewBox={s.label === 'LinkedIn' ? '0 0 24 24' : '0 0 24 24'} fill="currentColor">
                    <path d={s.path}/>
                  </svg>
                </a>
              ))}
        ...
        <div className="mt-12 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-gray-400">
            © {year} EduFlow Technologies, Inc. All rights reserved.
          </p>
          <p className="text-xs text-gray-400">
            Crafted for the ambitious learner.
          </p>
        </div>
      </div>
    </footer>
